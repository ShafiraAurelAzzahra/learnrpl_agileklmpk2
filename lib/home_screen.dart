...
class HomeScreen extends GetWidget<HomeController> {
  // Mendefinisikan HomeScreen sebagai widget GetWidget yang terhubung dengan HomeController
  const HomeScreen({Key? key}) : super(key: key); // Konstruktor HomeScreen

  @override
  Widget build(BuildContext context) {
    // Fungsi untuk membangun UI dari HomeScreen
    return SafeArea(
      // Menghindari area layar yang tidak dapat diakses
      child: Scaffold(
        // Menggunakan scaffold untuk struktur dasar halaman
        resizeToAvoidBottomInset:
            false, // Menghindari tampilan terpotong saat keyboard muncul
        ...
        body: Column(
          ...
          children: [
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment
                    .start, // Menyusun anak-anak kolom ke kiri
                children: [
                  Row(
                    // Menggunakan Row untuk menyusun widget secara horizontal
                    children: [
                      const Icon(Icons.person,
                          size: 32, color: Color(0XFF083791)), // Ikon profil
                        ...
                        children: const [
                          Text(
                            ...
                            style: TextStyle(
                                ...
                                color: Color(0XFF083791)), // Teks salam
                          ),
                          Text('Welcome App LearnRPL',
                              style: TextStyle(
                                  fontSize: 16,
                                  color: Color(0XFF083791))), // Teks sambutan
                        ],
                      ),
                    ],
                  ),
                  ...
                  Card(
                    // Membuat kartu untuk menampilkan informasi
                    color: const Color(0XFF083791), // Mengatur warna kartu
                    elevation: 5, // Mengatur elevasi kartu
                    child: Padding(
                      padding:
                          const EdgeInsets.all(16.0), // Padding di dalam kartu
                      child: Row(
                        // Menggunakan Row untuk menyusun isi kartu
                        children: [
                          Expanded(
                            // Menggunakan Expanded agar kolom menggunakan ruang yang tersedia
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment
                              ...
                              children: const [
                                ...
                                Text(
                                  ...
                                  style: TextStyle(
                                      color: Colors.white), // Teks deskripsi
                                ),
                              ],
                            ),
                          ),
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintStyle: const TextStyle(
                          color: Color(0XFF083791)), // Warna teks petunjuk
                      prefixIcon: const Icon(Icons.search,
                          color: Color(0XFF083791)), // Ikon pencarian
                      border: OutlineInputBorder(
                        borderRadius:
                            BorderRadius.circular(8), // Mengatur radius border
                        borderSide: const BorderSide(
                            color: Color(0XFF083791)), // Warna border
                      ),
                      focusedBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(
                            8), // Radius border saat fokus
                        borderSide: const BorderSide(
                            color:
                                Color(0XFF083791)), // Warna border saat fokus
                      ),
                    ),
                  ),
                ],
            ...
            const SizedBox(height: 20), // Ruang vertikal
            Expanded(
              // Menggunakan Expanded untuk mengisi ruang yang tersisa
              child: SingleChildScrollView(
                // Membuat scrollable widget
                child: Padding(
                  padding:
                      const EdgeInsets.all(16.0), // Padding di sekitar konten
                  child: Row(
                    // Menggunakan Row untuk menyusun item secara horizontal
                    mainAxisAlignment: MainAxisAlignment
                        .spaceBetween, // Memberikan ruang antara item
                    children: [
                      Expanded(
                        // Menggunakan Expanded agar item pertama menggunakan ruang yang tersedia
                        child: InkWell(
                          // Membuat widget dapat ditekan
                          onTap: () {
                            // Arahkan ke halaman TampilanMenuMateriScreen
                            Get.to(() =>
                                MateriPage()); // Navigasi ke halaman MateriPage
                          },
                          child: buildSingleItem(
                            // Memanggil fungsi untuk membangun item tunggal
                            'Materi',
                            'View Catalog Materi',
                      ...
                      Expanded(
                        // Menggunakan Expanded agar item kedua menggunakan ruang yang tersedia
                        child: InkWell(
                          // Membuat widget dapat ditekan
                          onTap: () {
                            // Arahkan ke halaman TampilanMenuMateriScreen
                            Get.to(() =>
                                QuizPage()); // Navigasi ke halaman QuizPage
                          },
                          child: buildSingleItem(
                            // Memanggil fungsi untuk membangun item tunggal
                            'Quiz',
        ...
        bottomNavigationBar: BottomNavigationBar(
          // Membuat bar navigasi di bagian bawah
          currentIndex: controller
              .currentIndex.value, // Menggunakan currentIndex dari controller
          onTap: (index) {
            // Fungsi untuk menangani tap pada item navigasi
            // Pindah halaman sesuai tab yang di-tap
            if (index == 0) {
              Get.to(
                  () => const HomeScreen()); // Navigasi ke halaman HomeScreen
            } else if (index == 1) {
          ...
          unselectedItemColor:
              const Color(0XFF083791), // Warna item yang tidak terpilih
          items: const [
      ...
      children: [
        Text(
          ...
          style: TextStyle(
              fontSize: 18,
              fontWeight: FontWeight.bold,
              color: titleColor), // Gaya teks untuk judul
        ),
        const SizedBox(height: 10), // Ruang vertikal
        Card(
          // Membuat kartu untuk item
              ...
              children: [
                Expanded(
                  child: Image.asset(
                    ...
                    width: double
                        .infinity, // Mengatur lebar gambar agar memenuhi kartu
                    fit:
                        BoxFit.cover, // Menyesuaikan gambar dengan ukuran kartu
                  ),
                ),
                InkWell(
                  // Membuat widget dapat ditekan
                  onTap: () {
                    // Fungsi saat item ditekan
                  ...
                  child: Container(
                    color:
                        Color(0XFF083791), // Warna latar belakang untuk tombol
                    width: double
                        .infinity, // Mengatur lebar tombol agar memenuhi kartu
                    padding:
                        const EdgeInsets.all(8.0), // Padding di dalam tombol
                    child: Text(
                      item, // Teks tombol
                      textAlign: TextAlign
