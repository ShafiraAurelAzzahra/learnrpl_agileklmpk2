...
class HomeController extends GetxController {
  // Controller untuk mengatur logika dan data yang terhubung dengan UI.
  ...
  var currentIndex = 0
      .obs; // Mendeklarasikan variabel currentIndex yang menyimpan nilai indeks tab saat ini, dan membuatnya menjadi observable dengan .obs

  void changeTabIndex(int index) {
    // Mendefinisikan metode changeTabIndex yang menerima parameter index
    currentIndex.value =
